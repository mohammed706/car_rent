...
const SearchManufacture = ({manuFacture,setManuFature}:SearchManuFactureProps) => {
    const [query,setQuery]=useState("")
    const filteredManufactrers = query === "" ? manufacturers: manufacturers.filter((item)=>(
        item.toLowerCase().replace(/\s+/g,"").includes(query.toLowerCase().replace(/\s+/g,""))
    ))
  return (
    <div className='search-manufacturer'>
        <Combobox value={manuFacture} onChange={setManuFature}>
